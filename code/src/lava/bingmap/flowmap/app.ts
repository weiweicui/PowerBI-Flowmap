import { Func, StringMap, Action, IRect, IBorder, dict, keys } from "../../type";
import { selex, ISelex } from "../../d3";
import { Controller, MapFormat } from '../../bingmap/controller';
import { Config } from "./config";
import { extent } from "d3-array";
import { scaleLinear, interpolateRgb, piecewise, scaleSqrt, scaleIdentity } from "d3";
...
export const events = {
    doneGeocoding: null as (locs: StringMap<ILocation>) => void
};
